                        ...
                        {["Studio", "1", "2", "3", "4+"].map((bedroom) => (
                          <Button
                            ...
                            className={`rounded-full ${
                              selectedBedrooms.includes(bedroom) ? "bg-blue-500 hover:bg-blue-600" : "bg-background"
                            }`}
                          >
                            {bedroom}
                          </Button>
      ...
      >
        <Sheet open={isAiChatOpen} onOpenChange={setIsAiChatOpen}>
          <SheetTrigger asChild>
            <Button
              size="lg"
              className="w-14 h-14 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-200 group"
            >
                      ...
                      <Card className="overflow-hidden bg-card/50 backdrop-blur-sm border border-border/50 shadow-md hover:shadow-xl transition-all duration-300 group">
                        <div className="relative aspect-[4/3] w-full overflow-hidden">
                          ...
                          >
                            <Heart
                              className={`w-4 h-4 ${
                                favoriteHouses.includes(house.id) ? "fill-red-500 text-red-500" : "text-foreground"
                              }`}
                            />
                          </Button>
                          ...
                          <div className="absolute bottom-4 right-4">
                            <div className="relative w-16 h-16">
                              <svg className="w-full h-full" viewBox="0 0 36 36">
                                <path
                                  className="stroke-current text-blue-100 dark:text-blue-900/20"
                                  fill="none"
                                  strokeWidth="3"
                                ...
                                <path
                                  ...
                                  fill="none"
                                  strokeWidth="3"
                                  strokeDasharray={`${house.match}, 100`}
                                  d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                                />
                                <text
                                  x="18"
                              ...
                              <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                                <Sparkles className="w-3 h-3 text-blue-500 absolute top-2.5 right-2.5" />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-1 mb-2">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`w-4 h-4 ${
                                i < Math.floor(selectedHouse.landlord.rating)
                  ...
                  <Button variant="outline" className="flex-1" onClick={() => toggleFavorite(selectedHouse.id)}>
                    <Heart
                      className={`w-4 h-4 mr-2 ${
                        favoriteHouses.includes(selectedHouse.id) ? "fill-red-500 text-red-500" : ""
                      }`}
                    />
